...
dispostivos GPS às charretes, permitindo aos espectadores desfrutarem de dados de telemetria 
em tempo real.
...
A descrição de uma charrete consiste de três inteiros N (1 ≤ N ≤ 99), D (0 ≤ D ≤ 1000) e 
V (0 ≤ V ≤ 50) indicando, respectivamente, o número da charrete, a sua distância à linha de 
chegada em metros, e a sua velocidade, em quilômetros por hora. Os números das duas charretes 
são distintos.

Output

Imprima uma única linha, contendo um único número inteiro, indicando o número da charrete que 
