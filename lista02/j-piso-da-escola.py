...
Além disso, ela quer preencher o piso da sala com as diagonais das lajotas 
alinhadas aos lados da sala, como na figura.

A loja vai fornecer lajotas do tipo 1: inteiras; do tipo 2, que correspondem 
à metade das do tipo 1, cortadas ao longo da diagonal; e lajotas do tipo 3, 
que correspondem à metade do tipo 2. Veja os três tipos de lajotas na figura.
...
número de lajotas dos tipos 1 e 2 que serão necessárias. Na figura, para 
L = 3 e C = 5, foram necessárias 23 do tipo 1 e 12 do tipo 2. Seu programa 
precisa computar, dados os valores de L e C, a quantidade de lajotas do 
tipo 1 e do tipo 2 necessárias.

Input

A primeira linha da entrada contém um inteiro L (1 ≤ L ≤ 100) indicando a 
largura da sala. A segunda linha contém um inteiro C (1 ≤ C ≤ 100) representando 
